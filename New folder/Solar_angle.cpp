...
private:
    ...
    const int Bengaluru[15] = {40, 18, 13, 10, 0, -11, 3, 5, 12, 21, 29, 36, 36, 36, 35};
    ...
    do
    {
        ...
        if (choice == 1 || choice == 2 || choice == 3 || choice == 4 || choice == 5)
        {
            cout << endl
                 << endl;
            if (choice == 1)
                cout << " \t\t\t\tYou selected BENGALURU" << endl
                     << endl;
            else if (choice == 2)
                cout << " \t\t\t\tYou selected CHENNAI" << endl
                     << endl;
            else if (choice == 3)
                cout << " \t\t\t\tYou selected DELHI" << endl
                     << endl;
            else if (choice == 4)
                cout << " \t\t\t\tYou selected KOLKATA" << endl
                     << endl;
            else
                cout << " \t\t\t\tYou selected MUMBAI" << endl
                     << endl;
            ...
            cout << endl
                 << "The average angle over a season for the selected city:" << endl;
            cout << endl
                 << "Summer\tWinter\tSpring/Autumn" << endl;
            if (choice == 1)
...
void position ::getdata()
{
    ...
    cout << "The Optimal Average Tilt Angle is: \t\t" << (int)avg_tilt << " degrees." << endl
         << endl
         << endl;
}
int main()
{
    ...
    do
    {
        ...
        cout << endl
             << "NOTE: ALL VALUES ARE IN DEGREES!" << endl;
        cout << "Do you want to use QUICK MODE OR DYNAMIC MODE?" << endl
             << "press 1 for QUICK MODE" << endl
             << "Press 2 for DYNAMIC MODE" << endl
             << "Press 0 to exit.";
        cin >> query;
        if (query == 1)
        {
